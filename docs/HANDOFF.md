...
- `origin/gh-pages` 為 `1b69ad1`（2026-09-26 17:23:52 +0800），部署 v0.9.1（v0.9.0 的 19 塊棋盤＋包夾斷能＋劣勢狂怒，加低幀率點地走過頭修正），建置來源 `f90cb13`（分支 `v090-encircle`，尚未併入 main）；線上首頁顯示 `v0.9.1 · build 2026-09-26 07:05 UTC · f90cb13`。驗收指南 §19、§20 記有實測結果。可回退送達點：v0.9.0 的 `f22519c`（來源 `5b7bab3`）、v0.8.0 的 `d232ee6`（來源 `96e143f`）。
...
- 下一步：① 使用者手機實玩觸發狂怒並截圖（修-10 後的 V9-D10，步驟見 §20）；② 通過後併入 main；③ 原生裝置手感。
